...
// Generated from a script called Tigra Color Picker at http://www.nobleresearch.com/admin/js/colour_palette/picker.js
// Note: the above script's generation of values 217 through 256 was incorrect. The final 40 values should be
// descending gradients of R, G, B, and grayscale with ten steps each. The script was generating 14 steps each.
// It still might be slightly wrong (gradient step?) but OH WELL.
uint8_t macPalette[256][3] = {
	...
	{0x00,0x33,0x33}, {0x00,0x33,0x00}, {0x00,0x00,0xFF}, {0x00,0x00,0xCC}, {0x00,0x00,0x99}, {0x00,0x00,0x66}, {0x00,0x00,0x33}, {0x00,0x00,0x00}, 
    {0xE7,0x00,0x00}, {0xCF,0x00,0x00}, {0xB7,0x00,0x00}, {0x9F,0x00,0x00}, {0x87,0x00,0x00}, {0x6F,0x00,0x00}, {0x57,0x00,0x00}, {0x3F,0x00,0x00}, 
	{0x27,0x00,0x00}, {0x0F,0x00,0x00}, {0x00,0xE7,0x00}, {0x00,0xCF,0x00}, {0x00,0xB7,0x00}, {0x00,0x9F,0x00}, {0x00,0x87,0x00}, {0x00,0x6F,0x00}, 
	{0x00,0x57,0x00}, {0x00,0x3F,0x00}, {0x00,0x27,0x00}, {0x00,0x0F,0x00}, {0x00,0x00,0xE7}, {0x00,0x00,0xCF}, {0x00,0x00,0xB7}, {0x00,0x00,0x9F}, 
	{0x00,0x00,0x87}, {0x00,0x00,0x6F}, {0x00,0x00,0x57}, {0x00,0x00,0x3F}, {0x00,0x00,0x27}, {0x00,0x00,0x0F}, {0xE7,0xE7,0xE7}, {0xCF,0xCF,0xCF}, 
	{0xB7,0xB7,0xB7}, {0x9F,0x9F,0x9F}, {0x87,0x87,0x87}, {0x6F,0x6F,0x6F}, {0x57,0x57,0x57}, {0x3F,0x3F,0x3F}, {0x27,0x27,0x27}, {0x0F,0x0F,0x0F}};

/* 
 * The Mac-specific parts of the palette were generated using a gradient step of 24
 * Gradient step using 17
	{0xEE,0x00,0x00}, {0xDD,0x00,0x00}, {0xCC,0x00,0x00}, {0xBB,0x00,0x00}, {0xAA,0x00,0x00}, {0x99,0x00,0x00}, {0x88,0x00,0x00}, {0x77,0x00,0x00}, 
	{0x66,0x00,0x00}, {0x55,0x00,0x00}, {0x00,0xEE,0x00}, {0x00,0xDD,0x00}, {0x00,0xCC,0x00}, {0x00,0xBB,0x00}, {0x00,0xAA,0x00}, {0x00,0x99,0x00}, 
	{0x00,0x88,0x00}, {0x00,0x77,0x00}, {0x00,0x66,0x00}, {0x00,0x55,0x00}, {0x00,0x00,0xEE}, {0x00,0x00,0xDD}, {0x00,0x00,0xCC}, {0x00,0x00,0xBB}, 
	{0x00,0x00,0xAA}, {0x00,0x00,0x99}, {0x00,0x00,0x88}, {0x00,0x00,0x77}, {0x00,0x00,0x66}, {0x00,0x00,0x55}, {0xEE,0xEE,0xEE}, {0xDD,0xDD,0xDD}, 
	{0xCC,0xCC,0xCC}, {0xBB,0xBB,0xBB}, {0xAA,0xAA,0xAA}, {0x99,0x99,0x99}, {0x88,0x88,0x88}, {0x77,0x77,0x77}, {0x66,0x66,0x66}, {0x55,0x55,0x55}};
*/
